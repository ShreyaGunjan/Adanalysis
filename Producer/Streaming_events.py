...
events_file_path = os.path.join(os.path.expanduser('~'), 'adanalysis','data','events.csv')
display_file_path = os.path.join(os.path.expanduser('~'), adanalysis','data','display_ad.csv')
